...
# UAT Configuration
$Global:UATConfig = @{
    SiteUrl = "https://tenant.sharepoint.com/sites/Solutions-UAT"
    TargetListGuids = @(
...
# Prod Configuration
$Global:ProdConfig = @{
    SiteUrl = "https://tenant.sharepoint.com/sites/solutions"
    TargetListGuids = @(
...
function Connect-IndicatedSite {
    ...
    do {
        try {
            ...
            Connect-PnPOnline -Url $SiteUrl -clientId 00000000-0000-0000-0000-000000000000 -interactive
