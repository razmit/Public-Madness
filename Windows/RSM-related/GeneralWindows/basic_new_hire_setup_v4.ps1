...
$NewBookmarks = @(
    ...
    @{ "name" = "RSM US-El Salvador Team Site"; "url" = "https://rsmnet.sharepoint.com/sites/Teams/Consulting/elsalvadorteam/Pages/default.aspx" }
    @{ "name" = "RSM US SV Office"; "url" = "https://rsmnet.sharepoint.com/sites/Teams/Consulting/elsalvadorteam/Pages/RSM-US-SV-Office.aspx" }
